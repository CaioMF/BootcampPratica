...
import com.example.rest.restaurant.service.OrderService;
...
public class OrderController {
    ...
    public List<Order> findByStatus(@PathVariable boolean value){
        return orderService.findByStatus(value);
    }
